...
@section('content')
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div class="mt-4">
                @if (!$ticket->support_engineer_id)
                    <form method="POST" action="{{ route('support.tickets.claim', $ticket->id) }}" class="inline-block">
                        @csrf
                        @method('PUT')
                        <button type="submit"
                ...
                @elseif ($ticket->support_engineer_id === auth()->id())
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            @if ($ticket->support_engineer_id === auth()->id())
                <form method="POST" action="{{ route('support.tickets.comments.store', $ticket->id) }}">
                    @csrf
                    <div class="mb-4">
            ...
            @else
                <p class="text-gray-600">You cannot add comments until you claim this ticket.</p>
            @endif
        </div>
    </div>
@endsection
